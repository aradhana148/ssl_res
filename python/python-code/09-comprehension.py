...
#even_odd_labels=[x for x in range(5) if x%2==0 else (x)]
...
#modified_words=[word.upper() for word in words if len(word)>4]
...
#exp if condtion else exp for item in iterable
