...
print("9. List after removing 'orange' and poopping index 1:", my_fruits)
...
fruits_with_multiple_apples = ["apple", "banana", "apple", "cherry", "apple","banana"]
apple_count = fruits_with_multiple_apples.count("apple")
print("18. Count of 'apple' in the list:", apple_count)

# Using index() to find the index of a specific item#print(sorted_totalData)
#print(sorted_totalData1)
