...
reshaped_3d = arr_2d.reshape((1, -1, 3))  # 2D to 3D
...
flat_2d = arr_2d.flatten()  # Flatten 2D to 1D (arr.reshape(-1))
...
expanded_3d = np.expand_dims(arr_3d, axis=2)  # Add a new axis in between (make it 4D)
